...
| R56 Desktop builds on macOS, Linux, and Windows, with macOS lifecycle E2E and unsigned packaging | local macOS arm64 production build, lifecycle E2E, Fuse inspection, and unsigned ZIP make passed; `.github/workflows/ci.yml` adds cross-platform Desktop typecheck/unit/build coverage and a macOS E2E/make job | Partial |
