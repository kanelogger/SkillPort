...
const bridge: DesktopBridge = {
  ...
  checkUpdate: (input) => invoke("checkUpdate", input),
  checkAllUpdates: () => invoke("checkAllUpdates"),
  previewUpdate: (input) => invoke("previewUpdate", input),
  previewAllUpdates: (input = {}) => invoke("previewAllUpdates", input),
  update: (input) => invoke("update", input),
  updateAll: (input = {}) => invoke("updateAll", input),
